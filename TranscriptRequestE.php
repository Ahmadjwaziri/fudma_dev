...
$(document).ready(function() {
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">New Application(Electronic Request Form)</h2>
        </div>
 ...
 <br>
                         ...
                         <div class="row">
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-lg-4">
                                  ...
                                  <div class="form-group">
                                      <select class="form-control selectpicker" data-live-search="true" name="dmode" >
  ...
  <br>
                                     ...
                                     <button type="submit" class="btn btn-info btn-lg" name="save_appE">Apply</button>
                                 </div>
                             </div>
