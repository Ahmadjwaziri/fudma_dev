				...
				<div class="col-lg-6">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" required="" class="form-control" id="firebase_api" placeholder="Enter Firebase Server API Key" value="AAAA2duc7ig:APA91bFxglXkl_YjrO0wlUbGVwkExI1LOacVBMUUNuwLVAlcVFuUTM_2TAKyQEcFC95U9H_kumR16bvp1eWGMkIGo0BRngXI3bWxCcTVIrlCBNYfhVqOXE7gsDvHyYTMXf-xqMcA_6Sy" name="firebase_api">
						</div>
