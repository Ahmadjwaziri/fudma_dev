...
<body>
    ...
    <ul>
        <li>Check your <strong>Email</strong> to get new password requested</li>
                            ...
                            <div class="face front"> 
                                <div class="panel panel-default">
                                    <form class="form-horizontal" name="sign_in_form" id="sign_in_form">
                                        ...
                                        <p id="sign_in_result"><button class="btn btn-primary btn-block" id="btn_sign_in">FORGOT</button></p>
                                        <div id="haqq"></div>
                                        <hr>
