...
include("Config/BillerService.php");
include("Config/Credentials.php");
include("GenerateRRRObjects/Values.php");
include("GenerateRRRObjects/CustomFields.php");
include("GenerateRRRObjects/GenerateRRRRequest.php");
include("Config/ServiceParam.php");
include("ValidateRRRObjects/ValidateRRRRequest.php");
include("BillPaymentNotificationObjects/BillPaymentNotificationRequest.php");
...
class TestBilling
{
    ...
    function call_validateRRR()
    {
        ...
        $payload->setAmount(100);
        $payload->setPayerPhone("08085519759");
        $payload->setPayerEmail("haqq4peace@gmail.com");
        $payload->setPayerName("Tokunbo Omonubi");
        $value = new Values();
        $value->setAmount(100);
        $value->setQuantity(0);
